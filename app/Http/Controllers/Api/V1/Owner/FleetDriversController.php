...
class FleetDriversController extends BaseController
{
    ...
    public function addDriver(Request $request){
        ...
        DB::commit();
         ...
         $this->database->getReference('drivers/driver_'.$driver->id)->set(['id'=>$driver->id,'vehicle_type'=>'fleet-owner-type','approve'=>0,'active'=>0,'updated_at'=> Database::SERVER_TIMESTAMP]);
     
        // Log::info($this->database->getReference('drivers/driver_'"driver_".$driver->id));
