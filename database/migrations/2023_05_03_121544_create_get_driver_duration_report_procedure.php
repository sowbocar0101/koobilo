        ...
        DB::unprepared("
            ...
            BEGIN
                ...
                if(@data_exists > 0) then
                    ...
                    left join (SELECT driver_id, sum(duration) as duration, date(created_at) as date FROM driver_availabilities where driver_id = dr_id and created_at between date1 and date2 group by date, driver_id) B on B.date = A.selected_date
