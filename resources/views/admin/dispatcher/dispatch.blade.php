...
@section('content')
    ...
    <section class="content" style="min-height: 0;padding: 0;">
                ...
                <div class="box mb-0">
                    <div class="box-header with-border text-right">
                        <h4 class="box-title">
                            ...
                            <button type="button" class="btn btn-primary mx-4 btn-sm turned-button mr-auto" data-id="ride-without-destination"
        ...
        <div id="ride-without-destination" class="modal fade" role="dialog">
            <div class="modal-dialog container">
                <!-- Modal content-->
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">
                            @lang('view_pages.ride_without_destination')
                        </h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body">
