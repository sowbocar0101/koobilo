<div class="box-body no-padding">
    ...
    @if(auth()->user()->can('surge-zone'))            
           ...
           <a class="dropdown-item" href="{{url('zone/surge/Sunday',$result->id)}}"><i class="fa fa-plus"></i>@lang('view_pages.sunday')</a>
           <a class="dropdown-item" href="{{url('zone/surge/Monday',$result->id)}}"><i class="fa fa-plus"></i>@lang('view_pages.monday')</a>
           <a class="dropdown-item" href="{{url('zone/surge/Tuesday',$result->id)}}"><i class="fa fa-plus"></i>@lang('view_pages.tuesday')</a>
           <a class="dropdown-item" href="{{url('zone/surge/Wednesday',$result->id)}}"><i class="fa fa-plus"></i>@lang('view_pages.wednesday')</a>
           <a class="dropdown-item" href="{{url('zone/surge/Thursday',$result->id)}}"><i class="fa fa-plus"></i>@lang('view_pages.thursday')</a>
           <a class="dropdown-item" href="{{url('zone/surge/Friday',$result->id)}}"><i class="fa fa-plus"></i>@lang('view_pages.friday')</a>
           <a class="dropdown-item" href="{{url('zone/surge/Saturday',$result->id)}}"><i class="fa fa-plus"></i>@lang('view_pages.saturday')</a>
    @endif    
