...
<script>
  ...
  window.addEventListener('load', function() {
    console.log(typeof google,'test');
                if (typeof google === 'undefined') {
                    setTimeout(function() {
                        window.location.reload();
                    }, 5000); // Retry after 5 seconds if google is undefined
                }
            });
 ...
 <!-- Select goods type -->
                ...
                <div class="p-5">
                  <div class="row">
                    ...
                    name="goods_type" style=" padding: 5px; height:45px; user-select: none;cursor: pointer;color:black;">
