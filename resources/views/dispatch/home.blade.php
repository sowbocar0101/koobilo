...
@section('dispatch-content')
    ...
    <main class="main">
        <div class="container-fluid">
            ...
            {{-- @include('dispatch.ride-without-destination') --}}
...
@push('dispatch-js')
    ...
    measurementId: "{{get_settings('firebase-measurement-id')}}"
        ...
        $(document).on('click', '.booking_screen', function() {
            ...
            $('#ride-without-destination').attr('data-modal', modal)
            ...
            }else if (modal == 'ride-without-destination') {
                $('.date-option').addClass('d-none');
                $('.location').addClass('d-none');
                $('.modal-title').text('Ride Without Destination')
            }else {
